...
SIMILAR_GROUPS = [
    ...
    ["点", "捺"],
    ["竖提", "斜钩", "竖弯"],
    ["捺提", "竖提"],  # 用户裁定(2026-09-13):捺提↔竖提相互参考
    ["竖", "竖钩", "弯钩"],
    ["竖折折", "竖折弯钩"],
    ["扁斜钩", "竖弯钩"],
    ["横斜钩", "横斜弯钩"],
...
KAI_TARGET_MAP = {
    ...
    "撇": {"take": [(0x31D2, "八", "左")]},
    "横折": {"take": [(0x31D5, "己", "上")]},
    # 码位笔误修正(2026-09-13):原写 0x31D2(㇒撇)——鸿蒙等无码位区
    # 字体走 八·右 提取无恙,宋体有码位区短路取形,捺模板拿到镜像的
    # 撇形;0x31CF ㇏ 才是捺(本文件码位名表自证)。次选 0x31DF ㇟
    # (竖弯钩,儿·右)同为错串,一并移除,保留 八·右 提取兜底。
    "捺": {"take": [(0x31CF, "八", "右")]},
    "横折钩": {"take": [(0x31C6, "刁", "右")]},
    "竖折": {"take": [(0x31C4, "亡", "下")]},
    "竖钩": {"take": [(0x31DA, "小", "中")]},
    ...
    "撇钩": {"take": [(0x31D2, "八", "左")]},
    "横捺": {"take": [(0x31D0, "一", None), (None, "三", "中"),
                  (0x31C0, "刁", "左")]},
